      ...
      <div className="flex flex-col gap-6 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start md:items-stretch">
          <div className="md:col-span-2">
            <div
              className="relative w-full aspect-video rounded-lg bg-zinc-200 dark:bg-zinc-800 overflow-hidden"
          ...
          <aside className="md:col-span-1 md:sticky md:top-24 self-stretch">
            <div className="h-full flex flex-col rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 gap-4 shadow-sm">
              <section>
